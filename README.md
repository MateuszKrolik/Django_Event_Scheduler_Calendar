...
<h3 align="center">Django_Event_Scheduler_Calendar</h3>
  ...
  <p align="center">
    <br />
    <a href="https://github.com/MateuszKrolik/Django_Event_Scheduler_Calendar"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://github.com/MateuszKrolik/Django_Event_Scheduler_Calendar">View Demo</a>
    ·
    <a href="https://github.com/MateuszKrolik/Django_Event_Scheduler_Calendar/issues/new?assignees=&labels=bug&projects=&template=bug-report.md" >Report Bug</a>
    ·
    <a href="https://github.com/MateuszKrolik/Django_Event_Scheduler_Calendar/issues/new?assignees=&labels=enhancement&projects=&template=feature-request.md">Request Feature</a>
  </p>
</div>
...
You should have Python3 and Docker-Desktop installed.

I also suggest setting up a virtual environment via Conda for centralization, then managing it w/ Anaconda Navigator.

### Installation

1. Clone the repo
   ```sh
   git clone https://github.com/MateuszKrolik/Django_Event_Scheduler_Calendar.git
   ```
...
3. Enter your environment variables in `.env` and `GCP Secret Manager`.
   ...
   GCLOUD_ID = "ENTER YOUR GCLOUD_ID";
   GCLOUD_PROJECT_NUMBER = "ENTER YOUR GCLOUD_PROJECT_NUMBER";
   ```
...
```sh
chmod +x gcloud_custom.sh # make executable
./gcloud_custom.sh
```
...
- [x] Test-Driven-Development(TDD) - Unit Testing via:
  - [x] PyTest
  - [x] Mock Requests
- [x] External API Communication via Python Requests Module
- [x] Error Handling
...
- [x] Best Practices
- [x] Bootstrap Library for Mobile Responsiveness

See the [open documentation](https://github.com/MateuszKrolik/Django_Event_Scheduler_Calendar/issues) for a full list of proposed features (and known issues).
...
Project Repository Link: [https://github.com/MateuszKrolik/Django_Event_Scheduler_Calendar](https://github.com/MateuszKrolik/Django_Event_Scheduler_Calendar)
...
[contributors-shield]: https://img.shields.io/github/contributors/MateuszKrolik/Django_Event_Scheduler_Calendar.svg?style=for-the-badge
[contributors-url]: https://github.com/MateuszKrolik/Django_Event_Scheduler_Calendar/graphs/contributors
[forks-shield]: https://img.shields.io/github/forks/MateuszKrolik/Django_Event_Scheduler_Calendar.svg?style=for-the-badge
[forks-url]: https://github.com/MateuszKrolik/Django_Event_Scheduler_Calendar/network/members
[stars-shield]: https://img.shields.io/github/stars/MateuszKrolik/Django_Event_Scheduler_Calendar.svg?style=for-the-badge
[stars-url]: https://github.com/MateuszKrolik/Django_Event_Scheduler_Calendar/stargazers
[issues-shield]: https://img.shields.io/github/issues/MateuszKrolik/Django_Event_Scheduler_Calendar.svg?style=for-the-badge
[issues-url]: https://github.com/MateuszKrolik/Django_Event_Scheduler_Calendar/issues
[license-shield]: https://img.shields.io/github/license/MateuszKrolik/Django_Event_Scheduler_Calendar.svg?style=for-the-badge
[license-url]: https://github.com/MateuszKrolik/Django_Event_Scheduler_Calendar/blob/master/LICENSE
